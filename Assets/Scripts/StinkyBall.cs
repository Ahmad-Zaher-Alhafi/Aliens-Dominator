...
public class StinkyBall : MonoBehaviour
{
    ...
    public Constants.ObjectsColors StinkyBallColor
    {
        get
        {
            return stinkyBallColor;
        }
    }
    ...
    /// <summary>
    /// the particles inside the stinky ball(trail and explosion) needs time to geet destroied so we unparent them from the stinky ball and destroy them after time when the particle effect finish
    /// </summary>
