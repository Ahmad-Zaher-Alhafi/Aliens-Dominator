...
public class Projectile : MonoBehaviour
{
    ...
    public void FollowTarget(Creature target)
    {
        WasShoot = true;
    ...
    private void RotateToTheWantedAngle(Creature objectToLookAt)
    {
        if (objectToLookAt == null || objectToLookAt.WasDied)
        {
            return;
        }
        ...
        {
            transform.LookAt(objectToLookAt.transform.position + targetOffset);//look at the target
        }
